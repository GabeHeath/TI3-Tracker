...
$(function() {
	...
	$('#sc1left').click({sc: 1, arrow: -1}, setStrategyCards);
	$('#sc1right').click({sc: 1, arrow: 1}, setStrategyCards);
	$('#sc2left').click({sc: 2, arrow: -1}, setStrategyCards);
	$('#sc2right').click({sc: 2, arrow: 1}, setStrategyCards);
	$('#sc3left').click({sc: 3, arrow: -1}, setStrategyCards);
	$('#sc3right').click({sc: 3, arrow: 1}, setStrategyCards);
	$('#sc4left').click({sc: 4, arrow: -1}, setStrategyCards);
	$('#sc4right').click({sc: 4, arrow: 1}, setStrategyCards);
	$('#sc5left').click({sc: 5, arrow: -1}, setStrategyCards);
	$('#sc5right').click({sc: 5, arrow: 1}, setStrategyCards);
	$('#sc6left').click({sc: 6, arrow: -1}, setStrategyCards);
	$('#sc6right').click({sc: 6, arrow: 1}, setStrategyCards);
	$('#sc7left').click({sc: 7, arrow: -1}, setStrategyCards);
	$('#sc7right').click({sc: 7, arrow: 1}, setStrategyCards);
	$('#sc8left').click({sc: 8, arrow: -1}, setStrategyCards);
	$('#sc8right').click({sc: 8, arrow: 1}, setStrategyCards);
});
...
function setStrategyCards(event) {
	...
	if ((seEnabled == 1) && (sottEnabled == 1)) {
		...
		window['sc' + scArray[event.data.sc] ] = (scArray[event.data.sc]) + event.data.arrow; // set the sc var above to that value in the array +/- to the arrow value.

		if (window['sc' + scArray[event.data.sc] ] > scArray[event.data.sc]) { // If the sc var is higher than the scArray value, set it to 0. Simulates carousel loop.
			window['sc' + scArray[event.data.sc] ] = 0;
		} else if (window['sc' + scArray[event.data.sc] ] < 0 ) { // If it is below 0, set it to highest carousel value. Simulates loop.
			window['sc' + scArray[event.data.sc] ] = scArray[event.data.sc];
		}
