	...
	if ($num_rows_to_load != 0) {
		...
		for ($counter = 1; $counter <= $num_rows_to_load; $counter++) {
			if ($counter == $num_rows_to_load) {
				array_push($html_output,"<tr id='row{$counter}'><td>{$counter}</td><td id='color_{$counter}'><select id='colorselector_player_{$counter}'><option value='black' data-color='#000000' selected>black</option><option value='blue' data-color='#0000FF'>blue</option><option value='gray' data-color='#B2B2B2'>gray</option><option value='green' data-color='#009900'>green</option><option value='orange' data-color='#FF9900'>orange</option><option value='purple' data-color='#990099'>purple</option><option value='red' data-color='#FF0000'>red</option><option value='yellow' data-color='#FFFF00'>yellow</option></select><script>$('#colorselector_player_{$counter}').colorselector();</script></td><td><input id='player_name_{$counter}' type='text' placeholder='Player {$counter}'></td><td><select id='player_race_{$counter}' class='form-control' name='race_player_{$counter}'><option value='' selected disabled>Select Race</option><option class='sott-option' value='The Arborec'>The Arborec</option><option value='The Barony of Letnev'>The Barony of Letnev</option><option class='se-option' value='The Clan of Saar'>The Clan of Saar</option><option class='se-option' value='The Embers of Muaat'>The Embers of Muaat</option><option value='The Emirates of Hacan'>The Emirates of Hacan</option><option value='The Federation of Sol'>The Federation of Sol</option><option class='sott-option' value='The Ghosts of Creuss'>The Ghosts of Creuss</option><option value='The L1Z1X Mindnet'>The L1Z1X Mindnet</option><option class='sott-option' value='The Lazax'>The Lazax</option><option value='The Mentak Coalition'>The Mentak Coalition</option><option value='The Naalu Collective'>The Naalu Collective</option><option class='sott-option' value='The Nekro Virus'>The Nekro Virus</option><option value='The Sardakk N'orr'>The Sardakk N'orr</option><option value='The Universities of Jol-Nar'>The Universities of Jol-Nar</option><option class='se-option' value='The Winnu'>The Winnu</option><option value='The Xxcha Kingdom'>The Xxcha Kingdom</option><option class='se-option' value='The Yin Brotherhood'>The Yin Brotherhood</option><option value='The Yssaril Tribes'>The Yssaril Tribes</option></select></td><td><a class='close' id='remove_row_{$counter}' onclick='removeRow({$counter})' href='#'>&times</a></td></tr>"); // has delete row button
			} else {
